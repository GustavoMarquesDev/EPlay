...
import creditCard from '../../assets/images/Cartao_de_Credito.png'
    ...
    onSubmit: (values) => {
      purchase({
        ...
        payment: {
          ...
          card: {
            active: payWithCard,
            code: Number(values.cardCode), // Para converter para nummero, pois o retorno vinha como string
                    ...
                    <S.Row marginTop="24px">
                      <S.InputGroup>
                        ...
                        <input
                          ...
                          onBlur={form.handleBlur}
                          className={
                            checkInputsHasError('cardDisplayName')
                              ? 'error'
                              : ''
                          }
                        />
                      ...
                      <S.InputGroup maxWidth="123px">
                        ...
                        <InputMask
                          ...
                          onBlur={form.handleBlur}
                          className={
                            checkInputsHasError('expiresMonth') ? 'error' : ''
                          }
                          mask={'99'}
                        />
                      </S.InputGroup>
